...
|------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------|--------|
| 01                | Alta | Como tomador de decisões de políticas públicas, quero visualizar dados de analise de eficiencia de terminais portuários.                                                    | 4          | 2      |
| 02                |Alta  | Como tomador de decisões de políticas públicas, quero entender o porque as cargas foram paradas em portos.                                                    | 4          | 2      |
| 03                |Alta  | Como tomador de decisões de políticas públicas, quero visualizar a analise de eficencia de terminais portuários.                                                    | 3          | 2      |
